...
const translations = {
  ...
  ca: {
    ...
    about: {
      ...
      bioLine6: "En lloc de normes jurídiques, empro l'afecte i el cos com a eines de resistència",
      bioLine7: "davant l'estandardització de la vida.",
      bioLine8: "La meva recerca es desenvolupa en la cruïlla de l'art relacional, l'autobiogràfic i les tecnologies digitals,",
