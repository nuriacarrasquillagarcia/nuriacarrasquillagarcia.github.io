const translations = {
  es: {
    ...
    projects: {
      ...
      project3ImageCaption: "In Memoriam (2026)",
  ...
  ca: {
    ...
    projects: {
      ...
      project3Medium: "Mitjà: Dossier conceptual i pràctica escénica, 2026",
      project3ImageCaption: "In Memoriam (2026)",
    ...
    histericas: {
      ...
      fieldFormatValue: "Instal·lació en anamorfosi geomètrica — polígon equilàter visible desplaant-se 1 m a l'esquerra del punt de vista frontal",
